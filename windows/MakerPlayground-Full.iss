...
[UninstallDelete]
; delete all files downloaded and installed by the integrated platformio
Type: filesandordirs; Name: "{app}\dependencies"
...
Root: HKLM; Subkey: "Software\Classes\MakerPlayground\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\runtime\bin\javaw.exe"" -Duser.dir=""{app}"" --add-reads org.controlsfx.controls=javafx.base,javafx.graphics,javafx.controls --add-exports=javafx.base/com.sun.javafx.runtime=org.controlsfx.controls --add-exports=javafx.base/com.sun.javafx.collections=org.controlsfx.controls --add-exports=javafx.controls/com.sun.javafx.scene.control=org.controlsfx.controls --add-exports=javafx.controls/com.sun.javafx.scene.control.inputmap=org.controlsfx.controls --add-exports=javafx.controls/com.sun.javafx.scene.control.behavior=org.controlsfx.controls --add-exports=javafx.graphics/com.sun.javafx.scene.traversal=org.controlsfx.controls -p ""{app}\app"" -m io.makerplayground.frontend/io.makerplayground.ui.Main ""%1"""; Tasks: mpFileAssociation